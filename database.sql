...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2023 a las 18:42:03
...
CREATE TABLE `productos` (
  ...
  `categoria` enum('Electronica','Belleza','Videojuegos','Mobiliario','Oficina','Salud') NOT NULL,
...
ALTER TABLE `productos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `NIM_unique` (`precio`);
